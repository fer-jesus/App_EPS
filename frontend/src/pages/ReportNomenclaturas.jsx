...
import { exportChartsToPDFNomenclaturas } from "../utils/exportPdfNomenclaturas";

const ReportNomenclaturas = () => {
  ...
  const fetchReporte = async () => {
    try {
      ...
      const chartDataCantidad = reporte.map((r) =>
        parseInt(r.cantidad_nomenclaturas)
      );
  ...
  const handleDownload = () => {
    exportChartsToPDFNomenclaturas(["nomen-bar-chart"]);
  };
    ...
    <>
      ...
      <Container sx={{ mt: 4 }}>
        ...
        <div style={{ display: "grid", gap: "75px", marginTop: "50px" }}>
          <div
            id="nomen-bar-chart"
            style={{ width: "100%", height: "400px", marginBottom: "75px" }}
          >
...
export default ReportNomenclaturas;
